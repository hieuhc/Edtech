...
if __name__ == '__main__':
    ...
    weekly2all('data/data/teacher.csv', 'data/json_data/anonymous-teacher-events_16.2.29.json')
    weekly2all('data/data/student.csv', 'data/json_data/anonymous-student-events_16.2.29.json')
